...
function Testi({ nama, alamat, nomorTelpon, urlPhotoProfile }) {
  return (
    <div className="card p-4 m-4 border-2 w-100 h-26 justify-center align-center ">
      <div className="satu flex align-center justify-left gap-2 ">
        <img
          src={urlPhotoProfile}
          alt={``}
